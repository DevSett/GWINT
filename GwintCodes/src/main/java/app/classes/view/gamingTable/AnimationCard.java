...
public class AnimationCard {
    ...
    public AnimationCard(Pane card, double mainSizeX, double mainSizeY, double perSecondUpdate) {
        ...
        keyFrameCenter = new KeyFrame(Duration.seconds(perSecondUpdate),
                ...
                new KeyValue(card.prefHeightProperty(), card.getPrefHeight() * MainApp.getSingleton().getDel()),
                new KeyValue(card.prefWidthProperty(), card.getPrefWidth() * MainApp.getSingleton().getDel()));
